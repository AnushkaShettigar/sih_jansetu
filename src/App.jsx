...
export function Navbar() {
  const [open, setOpen] = useState(false); const links = [['Home', '/'], ['Report Issue', '/report-complaint'], ['Explore Reports', '/#track'], ['Contact Us', '/#about']]
